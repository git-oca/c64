...
// TODO Should be moved somewhere else outside of the framework
sprite_bar:
    .fill 3, $55
    .fill 3, $aa
    .fill 3, $ff
...
*=$3000 -2 "FONT"
font:
.import binary "./data/oca_font.64c"
...
.macro __next_seq_after(nb_frames) {
...
.macro __done_after(nb_frames) {
    __next_seq_after(nb_frames)
    __return()
}
